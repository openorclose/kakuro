...
/*
    b   Black square on grid
    n   Number goes here (white square on grid)
    r   the integer following this represents clue pointing to the Right
    d   the integer following this represents clue pointing Down
    []  contains two clues which share the same square on the grid.
*/
let grid2 = [
    "bd3d4bbbbd15d3",
    "r4nnd16d6br3nn",
